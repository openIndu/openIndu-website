...
>
> **权威源**：[workflow-control-tower/team/principle.md](https://github.com/agentic-develop-playground/workflow-control-tower/blob/main/team/principle.md)
> 本文件为 openIndu-website 项目层覆盖版本，与权威源保持一致，如有冲突以权威源为准。
